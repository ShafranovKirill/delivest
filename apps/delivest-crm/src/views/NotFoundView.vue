...
<template>
  <div class="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-center">
    <div class="relative">
      <h1 class="text-[12rem] font-black text-slate-200 select-none animate-pulse">
        404
      </h1>
    ...
    <div class="mt-16 flex gap-4">
      <div class="w-3 h-3 rounded-full bg-slate-200 animate-bounce" style="animation-delay: 0.1s"></div>
      <div class="w-3 h-3 rounded-full bg-slate-200 animate-bounce" style="animation-delay: 0.2s"></div>
      <div class="w-3 h-3 rounded-full bg-slate-200 animate-bounce" style="animation-delay: 0.3s"></div>
    </div>
  </div>
</template>
